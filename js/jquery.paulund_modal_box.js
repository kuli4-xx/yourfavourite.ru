...
(function($){
	...
	$.fn.paulund_modal_box = function(prop){
		...
		var options = $.extend({
			...
			width : "500",
			title:"",
			description: "За годы работы мы успели зарекомендовать себя как надежный поставщик элитной продукции. Внимание к клиентам всегда было нашей отличительной чертой.",
			top: "20%",
			left: "30%",
		},prop);
